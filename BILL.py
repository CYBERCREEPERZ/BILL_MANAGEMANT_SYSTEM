...
class Bill_App:
    ...
    def total(self):
        ...
        self.total_cosmetics.set("RM. " + str(self.total_cosmetics_prices))
        self.tax_cos.set("RM. " + str(round(self.total_cosmetics_prices * 0.05)))
        ...
        self.total_grocery.set("RM. " + str(self.total_grocery_prices))
        self.tax_groc.set("RM. " + str(round(self.total_grocery_prices * 0.05)))
        # ======================Total Other Prices
        ...
        self.total_other.set("RM. " + str(self.total_other_prices))
        self.tax_other.set("RM. " + str(round(self.total_other_prices * 0.05)))
